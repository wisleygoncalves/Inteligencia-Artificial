...
class RandomForest(object):
    base_path = r"C:\Formacao_IA\Algoritmos_Machine_Learning\Random_Forest"
    ...
    def main(self):
        print('Iniciando o Programa de Machine de Learning com Random Forest...')
        ...
        self.tree_decision_graph(model)
    ...
    def tree_decision_graph(self, model):
        print('\nGerando Árvore de Decisão Graficamente..\n')

        tree_index = 3

        for i in range(0, tree_index):
            tree_to_visualize = model.estimators_[i]
